  ...
  <div class="rlv-orientacion">
    <div class="rlv-subnav">
      <b-nav>
        ...
        <b-nav-item @click="onMicologia()" class="rlv-subnav-item" active
          >Curso de Micología
        </b-nav-item>
      </b-nav>
    </div>
      ...
      <b-row>
        <b-col cols="12" md="12" lg="6">
          <b-row>
            ...
            <b-col cols="4">
              ...
              <p class="rlv-text-cursos">
                Tanto si deseas adquirir una formación básica para poder distinguir las setas más comunes en nuestros bosques como si quieres afianzar tus conocimientos y despejar dudas, esta es tu actividad.
              </p> 
              <p class="rlv-text-cursos">
                Consiste en una salida de campo con la compañía de un guía micológico. Se realiza en diversos escenarios de la Sierra de Guadarrama, con una duración de 2 horas.
                </p>             
            </b-col>
            <b-col cols="2"></b-col>
          </b-row>
        ...
        <b-col cols="12" md="12" lg="6">
          <div class="img-actividades d-flex justify-content-center">
            ...
            <b-img
              :src="require('../static/img/actividades/micologia.png')"
              fluid
            ></b-img>
    ...
    async loadActivity() {
      try {
        ...
        for (let i = 0; i < data.activity.length; i++) {
          if (data.activity[i].title === config. actividadMicologíaName) {
